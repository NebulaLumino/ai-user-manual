    ...
    <main className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-950 to-gray-900 text-white flex flex-col items-center justify-center p-6">
      <div className="w-full max-w-2xl space-y-6">
        <div className="text-center space-y-2">
          <h1 className="text-4xl font-bold" style="color: hsl(340,55%,55%)">Charitable Giving</h1>
          <p className="text-gray-400">Charitable giving optimizer (DAF vs QCD)</p>
        </div>
        <div className="bg-gray-800/60 border rounded-2xl p-6 space-y-4 shadow-xl" style="border-color: hsla(340,55%,55%, 0.3)">
          ...
          <button onClick={handleGenerate} disabled={loading || !input.trim()}
            ...
            style="background-color: hsl(340,55%,55%)">
            {loading ? "Generating..." : "Generate Analysis"}
          </button>
        </div>
        {output && (
          <div className="bg-gray-800/60 border rounded-2xl p-6" style="border-color: hsla(340,55%,55%, 0.3)">
            <h2 className="text-lg font-semibold mb-3" style="color: hsl(340,55%,55%)">Results</h2>
