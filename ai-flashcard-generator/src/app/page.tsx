    ...
    <div className='min-h-screen bg-gradient-to-b from-gray-900 via-gray-950 to-gray-900 text-white flex flex-col'>
      <div className='flex-1 flex flex-col items-center justify-center px-6 py-16'>
        <div className='w-full max-w-2xl'>
          <h1 className='text-3xl font-bold mb-2' style={ color: 'hsl(190,90%,55%)' }>Flashcard Generator</h1>
          <p className='text-gray-400 mb-8'>AI-powered flashcard generator. Enter your input below.</p>
          <form onSubmit={handleGenerate} className='space-y-4'>
            ...
            <button
              ...
              style={ backgroundColor: 'hsl(190,90%,55%)' }
            >
